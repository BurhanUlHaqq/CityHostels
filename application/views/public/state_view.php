		...
		<div class="row">
			...
			<div class="col-lg-9" style="border:1px solid black;">
				...
				<?php $i = 0; foreach ($hostelinfo as $info): ?>
					<a href="<?=base_url('searchhostels/show');?>"><div id="image" style="height: 250px; width: 30%; margin:1%; border:5px solid #f0f0f0; display: inline-block; position: relative;">
						
						<img src="<?= base_url('assets/images/'.$himages[$i]->front); ?>" height="100%" width="100%" style="position: absolute;">
						<div style="position: absolute; z-index: 100;color: white; height: 20%; width: 100%; background: rgba(0,0,0, 0.7);font-size: 20px;font-weight: bold; padding: 5px;"><?php echo $info->admin_name; ?></div>
						<div style="position: absolute; z-index: 100;color: white; height: 30%; width: 100%; background: rgba(0,0,0, 0.7); top: 70%; font-size: 14px; padding: 5px;"><?php echo $info->Discription; ?></div>
					</div></a>
				<?php $i++; endforeach; ?>
				</div>
